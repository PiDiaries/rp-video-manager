...
do
  ...
  do
    ...
    # Gameboy Palette
    sudo mkdir -p ~/RetroPie/BIOS/palettes
    sudo cp ~/rp-video-manager/shaders/default.pal ~/RetroPie/BIOS/palettes/
    ...
    echo ""
                  ...
                  echo ""
                  echo ""
                  rm -f ~/RetroPie/roms/mame-libretro/*.cfg

                  echo "ALL .cfg files have been removed from ~/RetroPie/roms/mame-libretro"
...
8) # Arcade-Bezels
           ...
           cp ~/rp-video-manager/users/arcade-bezels/arcade-bezel-retroarch-configs/Done/*.cfg ~/RetroPie/roms/mame-libretro/
 
           
           echo "Arcade bezel configs have been copied to ~/RetroPie/roms/mame-libretro - these will apply to matching roms with MAME 2003"
